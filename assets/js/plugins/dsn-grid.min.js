    ...
    function r(t) {
      ...
      return (
        ...
        Object.keys(e).length
          ? ((e.BRAR_csrf = dsnParam.dsn_csrf || !1), e)
          : {}
      );
    }
    e.default = function ({
  ...
  function (t, e, n) {
    ...
    async function o(t) {
      (await $body.find("script:not([src])").each(function () {
        ...
        await jQuery(t)
          .filter(
            'script[src*="plugins/elementor"],script[src*="plugins/woocommerce"], script[src*="plugins/BRAR"]',
          )
          .each(function () {
